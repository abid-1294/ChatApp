    ...
    <div className='h-screen w-full bg-primary_color flex justify-center items-center'>
      ...
      <h1 className='text-center font-bold text-[34px] text-[#03014C] font-Osans '>Forgot Password</h1>
          <div className='relative mt-[40px] pl-[30px]'>
                ...
                <button className='w-[180px] h-[60px] text-white font-Osans text-[16px] font-semibold bg-[#0066FF] rounded-lg px-[5px] py-[5px] cursor-pointer'><Link to='/login'>Back To Login</Link></button>
                </div>
